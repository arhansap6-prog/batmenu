...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "BAT MENU is a premium digital menu platform. Manage your restaurant menu with a permanent QR — no technical setup required." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "BAT MENU — Smart Digital Menus For Every Food Business" },
      { name: "twitter:description", content: "BAT MENU is a premium digital menu platform. Manage your restaurant menu with a permanent QR — no technical setup required." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/0a34e8b0-1fb5-4773-884a-3f5414d3ef8f" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/0a34e8b0-1fb5-4773-884a-3f5414d3ef8f" },
    ],
    links: [
